...
public abstract class Model<M extends Model> implements Serializable{
	...
	@SuppressWarnings("unchecked")
	public Page<M> paginate(int pageNumber, int pageSize, String sql, Object... args) throws InstantiationException, IllegalAccessException{
		...
		String sql_count = "select count(*) as num from ("+sql+") table_count";
		...
		return new Page<M>(result,pageNumber,pageSize,(int)totalRow,totalPage);
	}
